              ...
              if (_phoneCtrl.text.isNotEmpty)
                ...
                Text(
                  () {
                    final opt = _paymentOptions.firstWhere((o) => o['value'] == _paymentMethod, orElse: () => _paymentOptions[0]);
                    final prefixes = opt['prefixes'] as List<dynamic>;
                    return '${opt['label']} : préfixes ${prefixes.join(', ')}';
                  }(),
    ...
    return Center(
      child: Padding(
        ...
        child: _card(Column(
          ...
          children: [
            Text(opt['icon'] as String, style: const TextStyle(fontSize: 48)),
            const SizedBox(height: 16),
            ...
            Text(
              'Revenez sur PlayShop après avoir confirmé le paiement de ${_totalSnapshot.toStringAsFixed(0)} FCFA',
                  ...
                  try {
                    ...
                    if (status == 'success') {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Paiement en attente — réessayez dans quelques secondes'), backgroundColor: Colors.orange),
                      );
                    }
                  } catch (_) {}
                },
